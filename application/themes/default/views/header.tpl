...
<html lang="zxx">
	<head>
		...
		<!-- Header CSS.Start -->
		<link rel="stylesheet" href="https://cdn.amanthul.cu/web/css/roboto.css">
		...
		<script src="https://cdn.amanthul.cu/web/js/all.min.js" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
		...
		<!-- Header JS.End -->
		<link rel="stylesheet" type="text/css" href="https://cdn.amanthul.cu/web/css/datatables.min.css">

		<script type="text/javascript" src="https://cdn.amanthul.cu/web/js/datatables.min.js"></script>
