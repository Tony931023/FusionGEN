...
class Armory extends MX_Controller
{
    ...
    private function getIcon($id, $realm)
    {
        ...
        if ($cache !== false) {
            ...
            if ($cache2 != false) {
                return '<img src="https://wow-zamimg.amanthul.cu/static/icons/retail/small/' . $cache2 . '.jpg" align="absmiddle" />';
            } else {
                return '<img src="https://wow-zamimg.amanthul.cu/static/images/icons/small/inv_misc_questionmark.jpg" align="absmiddle" />';
            }
        } else {
